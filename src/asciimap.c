...
static int offsets[10][2] = {{-2, 0},
                             ...
                             {2,  2},
                             {2,  -2}};
static int offsets_worldmap[10][2] = {{-1, 0},
                                      {0,  1},
                                      {1,  0},
                                      {0,  -1},
                                      {0,  0},
                                      ...
                                      {1,  1},
                                      {1,  -1}};
static int door_offsets[10][2] = {{-1, 0},
                                  {0,  1},
                                  {1,  0},
                                  {0,  -1},
                                  {-1, 1},
 ...
 *****************************************************************************/
static void MapArea(room_rnum room, struct char_data *ch, int x, int y, int min, int max, int16_t xpos, int16_t ypos, bool worldmap);
