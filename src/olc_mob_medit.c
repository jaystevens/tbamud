...
static void medit_disp_stats_menu(struct descriptor_data *d) {
    ...
    if (CONFIG_MEDIT_ADVANCED) {
        ...
        write_to_output(d,
                        ...
                        cyn, nrm, cyn, yel, GET_INT(mob), cyn, nrm, cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_PARA), cyn,
                        nrm,
                        cyn, nrm, cyn, yel, GET_WIS(mob), cyn, nrm, cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_ROD), cyn,
                        nrm,
                        cyn, nrm, cyn, yel, GET_DEX(mob), cyn, nrm, cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_PETRI),
                        cyn, nrm,
                        cyn, nrm, cyn, yel, GET_CON(mob), cyn, nrm, cyn, nrm, cyn, yel, GET_SAVE(mob, SAVING_BREATH),
                        cyn, nrm,
