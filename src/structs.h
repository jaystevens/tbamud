 ...
 *    int8_t -                       -127                              127
 *   uint8_t -                          0                              255
 *   int16_t -                    −32,767                           32,767
 *  uint16_t -                          0                           65,535
 *   int32_t -             −2,147,483,647                    2,147,483,647
 *  uint32_t -                          0                    4,294,967,295
 *   int64_t - −9,223,372,036,854,775,807        9,223,372,036,854,775,807
...
/* BEFORE CHANGING THIS, make sure you change every other direction
 * and movement based item that this will impact. */
...
#define ROOM_HOUSE          11    /* (Reserved) Room is a house */
#define ROOM_HOUSE_CRASH    12    /* (Reserved) House needs saving */
#define ROOM_ATRIUM         13    /* (Reserved) The door to a house */
#define ROOM_OLC            14    /* (Reserved) Modifyable / !compress */
#define ROOM_BFS_MARK       15    /* (Reserved) breath-first search mark */
...
/* The total number of PLR Flags */
/* TODO - jason 2018-08-06 - NUM_PLR_FLAGS is not set here, is it needed ? */
...
#define AFF_BLIND           1   /* (Reserved) Char is blind */
...
#define MAX_LAST_ENTRIES      6000                 /* Max last comm entries??                      */
...
#define MAX_GOLD              INT32_MAX            /* Maximum possible on hand gold (2.14 Billion) */
#define MAX_BANK              INT32_MAX            /* Maximum possible in bank gold (2.14 Billion) */
...
struct room_data {
    ...
    int8_t light;                                           /* Number of light sources in room */
    ...
    struct list_data *events;                               /* used for mob events */
};
...
struct social_messg {
    ...
    /* If the char cant be found search the char's inventory and do these: */
